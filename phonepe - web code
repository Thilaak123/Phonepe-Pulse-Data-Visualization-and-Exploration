...
conn = pymysql.connect(host='localhost', user='root', password='Tikki@123', db='project2')
cursor = conn.cursor()
...
st.write('**(Note)**:-This data between **2018** to **2023(Till Qtr 3)** in **INDIA**')
...
if option == 'All India':
    ...
    with tab1:
        ...
        with tab1_2:
            ...
            df_in_tr_tab_qry_rslt1['Transaction_amount'] = df_in_tr_tab_qry_rslt1['Transaction_amount'].astype(
                float).apply(convert_to_crore2)
    ...
    with tab2:
        ...
        with tab2_1:
            ...
            try:
                ...
                st.error(
                    "where the aggregated_user data from 2022 (Qtr 2,3,4) to 2023 (Qtr 1,2,3) are not same like previous year Phonepe Pluse data, so can't feed data to sql and can't visualize ")
        ...
        with tab2_2:
            try:
                ...
                df_in_us_tab_qry_rslt1['User Count'] = df_in_us_tab_qry_rslt1['User Count'].astype(int).apply(
                    convert_to_lakh2)
                df_in_us_tab_qry_rslt1_fig = px.bar(df_in_us_tab_qry_rslt1, x='State', y='User Count',
                                                    color='User Count', color_continuous_scale='thermal',
    ...
    with tab4:
        ...
        with tab_789:
            ...
            try:
                ...
                df_st_us_tab_qry_rslt1_fig = px.bar(df_st_us_tab_qry_rslt1, x='Quarter', y='User Count',
                                                    color='User Count', color_continuous_scale='thermal',
    ...
    with tab5:
        ...
        with tab_135:
            ...
            df_top_tr_tab_qry_rslt1['Top Transaction amount'] = df_top_tr_tab_qry_rslt1[
                'Top Transaction amount'].astype(float).apply(convert_to_crore2)
    ...
    with tab6:
        ...
        cursor.execute(
            f"SELECT State, SUM(Registeredusers) AS Top_user FROM top_user WHERE Year='{top_us_yr}' GROUP BY State ORDER BY Top_user DESC LIMIT 10;")
        ...
        with tab_101:
            ...
            df_top_us_tab_qry_rslt1['Total User count'] = df_top_us_tab_qry_rslt1['Total User count'].astype(
                float).apply(convert_to_lakh2)
